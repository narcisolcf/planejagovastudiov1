...
import { StrategicFundamentals, SwotType, Perspective, StrategicObjective, ObjectiveRelationship, Indicator, Project, ProjectTask } from '../../types';
...
// --- TASKS MOCK DATA ---
let MOCK_TASKS: ProjectTask[] = [
  {
    id: 't1',
    projectId: 'proj1',
    title: 'Mapeamento de Processos Atuais',
    status: 'COMPLETED',
    startDate: '2025-01-15',
    endDate: '2025-02-15',
    progress: 100,
  ...
  },
  {
    ...
    endDate: '2025-03-01',
    progress: 100,
    assignedTo: 'Arq. Pedro'
  },
  {
    id: 't5',
    projectId: 'proj2',
    title: 'Licitação da Obra',
    status: 'DELAYED',
    startDate: '2025-03-02',
    endDate: '2025-04-15',
    progress: 20,
    assignedTo: 'Setor de Compras'
  }
];
...
export const tasksApi = {
  ...
  create: async (task: Partial<ProjectTask>) => {
    await new Promise(resolve => setTimeout(resolve, 600));
  ...
  update: async (id: string, updates: Partial<ProjectTask>) => {
    await new Promise(resolve => setTimeout(resolve, 400));
